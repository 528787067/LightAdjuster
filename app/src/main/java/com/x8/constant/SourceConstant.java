package com.x8.constant;

import com.x8.activity.R;
...
public class SourceConstant {
    ...
    public static final int LED_VALUE_STR[] = {
            R.string.led_value_1,
            R.string.led_value_2,
            R.string.led_value_3,
            R.string.led_value_4,
    };

    public static final int ADJUST_SEEKBAR_ID[] = {
            R.id.led1_seekbar,
            R.id.led2_seekbar,
            R.id.led3_seekbar,
            R.id.led4_seekbar,
    ...
    public static final int ADJUST_TEXT_ID[] = {
            R.id.led1_adjust_text,
            R.id.led2_adjust_text,
            R.id.led3_adjust_text,
            R.id.led4_adjust_text,
    };

    public static final int PARAM_TEXT_ID[] = {
            R.id.led1_param_text,
            R.id.led2_param_text,
            R.id.led3_param_text,
            R.id.led4_param_text,
    };
}
